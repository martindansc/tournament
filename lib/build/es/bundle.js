...
class Player {
  constructor(seed, extra_info, is_bye = false, name) {
    ...
    _defineProperty(this, "is_bye", void 0);
    _defineProperty(this, "extra_info", void 0);
    this.name = name;
    this.seed = seed;
    this.is_bye = is_bye;
...
class Stage {
  constructor(num, column, id = null) {
    ...
    /** @type{Player} */
    _defineProperty(this, "player_1", void 0);
    /** @type{Player} */
    _defineProperty(this, "player_2", void 0);
    /** @type{number} */
    _defineProperty(this, "player_1_score", void 0);
    /** @type{number} */
    _defineProperty(this, "player_2_score", void 0);
    /** @type{number} */
    _defineProperty(this, "result", void 0);
    /** @type{number} */
    _defineProperty(this, "next_winner", void 0);
    /** @type{number} */
    _defineProperty(this, "next_looser", void 0);
    /** @type{number} */
    _defineProperty(this, "previous_up", void 0);
    /** @type{number} */
    _defineProperty(this, "previous_down", void 0);
    /** @type{number} */
...
class SingleBracket {
  constructor(players) {
    /** @type {?number[]} */
    _defineProperty(this, "stages_columns_number", null);
    /** @type {?number[][]} */
    _defineProperty(this, "per_column_stage", null);
    /** @type {?number} */
    _defineProperty(this, "n_players", null);
    /** @type {?number} */
    _defineProperty(this, "n_stages", null);
    /** @type {?Player[]} */
    _defineProperty(this, "players", null);
    /** @type {?Stage[]} */
    _defineProperty(this, "stages", null);
    /** @type {number} */
    _defineProperty(this, "first_non_executed_stage", 0);
  ...
  consolePrint() {
    ...
    printTree(this.stages[this.stages.length - 1], node => {
      let players = "";
...
class LooserBracket {
  constructor(n_players, stage_initial_num) {
    ...
    _defineProperty(this, "first_non_executed_stage", 0);
    /** @type {number} */
    _defineProperty(this, "stage_initial_num", void 0);
...
class Tournament {
  ...
  addResultPoints(stage_id, points_player_1, points_player_2) {
    ...
    if (stage_id < this.bracket.n_stages) {
      ...
      this._createNextBracketIfNeeded();
      if (this.has_looser_bracket) this.looser_bracket.update();
      return;
    }
...
export { Result, Stage, Tournament };
