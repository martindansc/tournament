...
class Player {
    ...
    constructor(seed, extra_info, is_bye = false) {
        this.name = extra_info.name;
        this.id = extra_info.id;
        this.seed = seed;
        this.is_bye = is_bye;
    ...
    static bye(seed) {
        let new_player = new Player(seed, { name: "Bye", id: null }, this.is_bye = true);
        return new_player;
    }
}
