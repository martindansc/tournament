...
var it,st;class et extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,i;const s=super.createRenderRoot();return null!==(t=(i=this.renderOptions).renderBefore)&&void 0!==t||(i.renderBefore=s.firstChild),s}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,i,s)=>{var e,o;const n=null!==(e=null==s?void 0:s.renderBefore)&&void 0!==e?e:i;let r=n._$litPart$;if(void 0===r){const t=null!==(o=null==s?void 0:s.renderBefore)&&void 0!==o?o:null;n._$litPart$=r=new K(i.insertBefore(C(),t),t,void 0,null!=s?s:{})}return r._$AI(t),r})(i,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return I}}et.finalized=!0,et._$litElement$=!0,null===(it=globalThis.litElementHydrateSupport)||void 0===it||it.call(globalThis,{LitElement:et});const ot=globalThis.litElementPolyfillSupport;null==ot||ot({LitElement:et}),(null!==(st=globalThis.litElementVersions)&&void 0!==st?st:globalThis.litElementVersions=[]).push("3.3.3");const nt=0,rt=1,lt=2;class ht{num;id;player_1;player_2;player_1_score;player_2_score;result;next_winner;next_looser;previous_up;previous_down;column;extra_info;constructor(t,i,s=null){this.num=t,null==s&&(s=String(t)),this.column=i,this.id=s,this.player_1=null,this.player_2=null,this.player_1_score=0,this.player_2_score=0,this.result=nt,this.next_winner=null,this.next_looser=null,this.previous_up=null,this.previous_down=null,this.extra_info={}}hasPrevious(){return null!==this.previous_up}hasNext(){return null!==this.next_winner}hasPlayers(){return null!==this.player_1&&null!==this.player_2}}function at(){return n`
    ...
    `}window.customElements.define("tournament-stage",class extends et{static get styles(){return[at(),n`
            .stage-players {
        ...
        `}_printNextStage(){return z`
            <div class="next-stage-button" @click="${t=>this._onClick("next-stage")}">
                >
            </div>`}_onClick(t){if(!this.stage.hasPlayers())return;let i=new CustomEvent("stage-clicked",{bubbles:!0,composed:!0,detail:{position:t,stage:this.stage.id}});console.log(i),this.dispatchEvent(i)}_getName(t){return null!==t?t.name:""}_getIsBye(t){return null!==t&&t.is_bye}});class ct extends et{static get styles(){return[at(),n`
        .per-stage-column {
          gap: 1rem;
          justify-content: space-around;
        }
      `]}static get properties(){return{t:{type:Object},tname:{type:String},counter:{type:Number}}}constructor(){super(),this.t=null}_print_stages(t,i){let s=[];for(let e of i){let i=t.stages[e];s.push(z`<tournament-stage id="${i.num}" .stage="${i}"></tournament-stage>`)}return s}_print_columns(t){let i=[];for(let s=0;s<t.per_column_stage.length;s++){let e=t.per_column_stage[s];i.push(z`<div class="t-column per-stage-column">${this._print_stages(t,e)}</div>`)}return i}setTournament(t){console.log("Tournament data updated",t),this.t=t,this.requestUpdate()}i(t){}render(){if(console.log(this.tname),console.log(this.t),!this.t)return z`No data`;let t=this.t.bracket;return z`<div class="t-row gap-5">${this._print_columns(t)}</div>`}_onClick(){this.count++,this.dispatchEvent(new CustomEvent("count-changed"))}}window.customElements.define("tournament-viewer",ct);export{ct as TournamentViewer};
